    ...
    <footer
      ...
      <div
        ...
        <div className="flex justify-center">
          ...
          <a className="mr-6 text-neutral-600 dark:text-neutral-200" href="https://www.instagram.com/pratikk_dungano/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="black"
          ...
          <a className="mr-6 text-neutral-600 dark:text-neutral-200" href="https://www.linkedin.com/in/pratik-dungano-9a6892250/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="black"
          ...
          <a className="text-neutral-600 dark:text-neutral-200" href="https://github.com/Pratik-Dungano">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="black"
